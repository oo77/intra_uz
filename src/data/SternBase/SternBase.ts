...
const TypeOfsternBase = [
  {
    ...
    content1: {
      ru: 'Все оборудования установлены и смонтированы известной итальянской компанией «F.LLI FRAGOLA S.P.A.», которая является одной из ведущих компаний в области производства комбикормовых линий в мире для всех типов животных.',
      en: 'Все оборудования установлены и смонтированы известной итальянской компанией «F.LLI FRAGOLA S.P.A.», которая является одной из ведущих компаний в области производства комбикормовых линий в мире для всех типов животных.',
      uz: 'Все оборудования установлены и смонтированы известной итальянской компанией «F.LLI FRAGOLA S.P.A.», которая является одной из ведущих компаний в области производства комбикормовых линий в мире для всех типов животных.',
    },
    content2: {
