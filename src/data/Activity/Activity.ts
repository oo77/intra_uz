...
const Activity = [
  {
    ...
    rabbitBreed: {
      ...
      content:
        {
          ru: 'Для запуска крупнейшего в мире кролиководческого кластера «Моя Мечта» были привлечены ведущие инжиниринговые европейские компании «Meneghin Srl» (Италия) во время реализации проекта были учтены все факторы касающейся правильнойдеятельности данного кластера по всем международным и европейским стандартам.',
          en: 'Для запуска крупнейшего в мире кролиководческого кластера «Моя Мечта» были привлечены ведущие инжиниринговые европейские компании «Meneghin Srl» (Италия) во время реализации проекта были учтены все факторы касающейся правильнойдеятельности данного кластера по всем международным и европейским стандартам.',
          uz: 'Для запуска крупнейшего в мире кролиководческого кластера «Моя Мечта» были привлечены ведущие инжиниринговые европейские компании «Meneghin Srl» (Италия) во время реализации проекта были учтены все факторы касающейся правильнойдеятельности данного кластера по всем международным и европейским стандартам.',
        },
