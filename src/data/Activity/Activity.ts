...
const Activity = [
...

  {
    ...
    content1: {
      ru: `Наши кролики питаются комбинированными сухими кормами, приготовленными по специальной рецептуре, разработанной ведущими европейскими специалистами. Все оборудование установлены и смонтировано известной итальянской компанией «F.LLI FRAGOLA S.P.A.», которая является одной из ведущих компаний в области производства комбикормовых линий в мире для всех типов животных.`,
  ...
  },
  {
    ...
    content1: {
      ru: 'Полностью автоматизированная стеклянная теплица высокой урожайности площадью 10га с использованием новейшее технологичное оборудование, рекомендованных на лидирующих торговых площадках и отвечающим всем европейским стандартам',
      en: 'Полностью автоматизированная стеклянная теплица высокой урожайности площадью 10га с использованием новейшее технологичное оборудование, рекомендованных на лидирующих торговых площадках и отвечающим всем европейским стандартам',
      uz: 'Полностью автоматизированная стеклянная теплица высокой урожайности площадью 10га с использованием новейшее технологичное оборудование, рекомендованных на лидирующих торговых площадках и отвечающим всем европейским стандартам',
    },
